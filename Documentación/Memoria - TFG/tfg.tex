...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cleardoublepage
{\par\hfill \sffamily\bfseries\Huge\ Autorización de difusión}

Los abajos frimantes, alumnos y tutor del Trabajo Fin de Grado (TFG) en el Grado en Ingeniería Informática de la Facultad de Informática, autorizan a la Universidad Complutense de Madrid (UCM) a difundir y utilizar con fines académicos no comerciales y mencionando expresamente a su tutor el presente Trabajo Fin de Grado (TF):  \textquotedbl Desarrollo de una aplicación móvil para el tratamiento de las Enfermedades Cardiovasculares \textquotedbl{}, realizado durante el curso académico 2016/2017 bajo la dirección de el profesor José Ignacio Hidalgo Pérez en el Departamento de arquitectura de computadores y automática. Así mismo autorizan a la Universidad Complutense de Madrid a que sea depositado en acceso abierto en el respositorio institucional con el objeto de incrementar la difusión, uso e impacto del TFG en Internet y garantizar su preservación y acceso a largo plazo.

\vskip 10mm
$\makebox[\linewidth]{Madrid, 12 de junio de 2017}$

\vskip 40mm
\noindent\rule{\textwidth}{0.025mm}
\vskip 5mm
\noindent Ricardo Cajigas Arenas  \hspace*{\fill}José Ángel Sánchez Martín \quad 

\vskip 50mm
\centerline{\noindent\rule{5cm}{0.025mm}}
\vskip 5mm
\centerline{José Ignacio Hidalgo Pérez}
...
\begin{figure}[H]
\centering
\includegraphics[height= 2cm]{capturas_androidstudio/1.png}
\caption{Paso 1 - Cargando la configuración}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height= 7cm]{capturas_androidstudio/2.png}
\caption{Paso 2 - Comenzamos la instalación}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height= 7cm]{capturas_androidstudio/3.png}
\caption{Paso 3 - Elegimos los componentes}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height= 7cm]{capturas_androidstudio/4.png}
\caption{Paso 4 - Aceptamos la licencia}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height= 7cm]{capturas_androidstudio/5.png}
\caption{Paso 5 - Configuramos las opciones}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height= 7cm]{capturas_androidstudio/6.png}
\caption{Paso 6 - Elegimos la carpeta del menú de inicio}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height= 7cm]{capturas_androidstudio/7.png}
